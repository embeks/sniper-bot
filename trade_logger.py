...
class TradeLogger:
    ...
    def _write_headers(self):
        headers = [
            ...
            'entry_buyers', 'entry_velocity', 'token_age_sec', 'sells_at_entry',
    ...
    def log_trade(
        ...
        entry_buyers: int, entry_velocity: float, token_age_sec: float, sells_at_entry: int,
        ...
        row = [
            ...
            entry_buyers, f"{entry_velocity:.2f}", f"{token_age_sec:.1f}", sells_at_entry,
