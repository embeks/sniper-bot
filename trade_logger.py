...
class TradeLogger:
    ...
    def _write_headers(self):
        headers = [
            ...
            'sells_at_entry', 'largest_buy_pct', 'top2_concentration', 'bundled', 'unique_slots', 'slot_spread',
    ...
    def log_trade(
        ...
        sells_at_entry: int, largest_buy_pct: float, top2_concentration: float, bundled: bool, unique_slots: int, slot_spread: int,
        ...
        row = [
            ...
            sells_at_entry, f"{largest_buy_pct:.1f}", f"{top2_concentration:.1f}", "Y" if bundled else "N", unique_slots, slot_spread,
