...
MIN_BONDING_CURVE_SOL = 4.0   # Entry range 4-7 SOL
MAX_BONDING_CURVE_SOL = 7.0   # Standard range
...
# ============================================
MIN_UNIQUE_BUYERS = int(os.getenv('MIN_UNIQUE_BUYERS', '4'))   # 4 unique buyers minimum
