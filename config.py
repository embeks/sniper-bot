...
JITO_TIP_AMOUNT_SOL = float(os.getenv('JITO_TIP_SOL', '0.007'))  # Default 0.005 SOL - increased for better tx landing
...
MAX_SELLS_AT_ENTRY = int(os.getenv('MAX_SELLS_AT_ENTRY', '2'))
MIN_BUY_SELL_RATIO = float(os.getenv('MIN_BUY_SELL_RATIO', '4.0'))
