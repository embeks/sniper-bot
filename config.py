...
MAX_BONDING_CURVE_SOL = 6.0   # Tighter window
...
MAX_SELLS_BEFORE_ENTRY = int(os.getenv('MAX_SELLS_BEFORE_ENTRY', '2'))   # Stricter
...
MIN_TOKEN_AGE_SECONDS = float(os.getenv('MIN_TOKEN_AGE_SECONDS', '0.5'))   # Enter faster
