...
JITO_TIP_AMOUNT_SOL = float(os.getenv('JITO_TIP_SOL', '0.012'))  # Default 0.005 SOL - increased for better tx landing
JITO_TIP_AGGRESSIVE_SOL = float(os.getenv('JITO_TIP_AGGRESSIVE_SOL', '0.015'))  # For 0-sell tokens
...
MAX_SINGLE_BUY_PERCENT = float(os.getenv('MAX_SINGLE_BUY_PERCENT', '35.0'))  # Anti-bot: max % from single wallet (loosened from 30% to catch more runners)
...
MAX_TOP2_BUY_PERCENT = float(os.getenv('MAX_TOP2_BUY_PERCENT', '40.0'))  # Max % from top 2 wallets combined
